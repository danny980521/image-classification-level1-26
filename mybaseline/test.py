...
if __name__ == '__main__':
    ...
    model = torch.load('/opt/ml/mybaseline/model/exp31/resnet18_3_0.09312580506398624.pt')
    model.eval()
    ...
    # 제출할 파일을 저장합니다.
    submission.to_csv(os.path.join('/opt/ml/submissions', 'submission_resnet18_new_epoch4.csv'), index=False)
