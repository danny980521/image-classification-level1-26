    ...
    for epoch in range(args.epochs):
        ...
        with torch.no_grad():
            ...
            if val_f1 > best_val_f1:
                ...
                torch.save(model, "{}/{}_{}_{}.pt".format(save_dir, 'resnet18', epoch, val_loss))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--augmentation', type=str, default='MaskBaseDataset', help='data augmentation type (default: BaseAugmentation)')
