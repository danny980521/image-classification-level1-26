...
from dataset import MaskBaseDataset, TrainAugmentation, ValidAugmentation
...
def train(data_dir, model_dir, args):
    ...
    '''
    #transform = get_transforms(mean=(0.5,0.5,0.5), std=(0.2,0.2,0.2))
    ...
    for fold in range(5) :
        ...
        val_set.dataset.set_transform(valid_transform)
        ...
        for epoch in range(args.epochs):
            ...
            with torch.no_grad():
                ...
                torch.save(model, "{}/{}_{}_{}_{.4F}.pt".format(save_dir, 'effb4', fold, epoch, val_loss))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='My5foldDataset', help='dataset augmentation type (default: MaskBaseDataset)')
    ...
    parser.add_argument('--batch_size', type=int, default=12, help='input batch size for training (default: 64)')
    parser.add_argument('--valid_batch_size', type=int, default=12, help='input batch size for validing (default: 1000)')
    parser.add_argument('--model', type=str, default='effb4', help='model type (default: BaseModel)')
    ...
    parser.add_argument('--data_dir', type=str, default=os.environ.get('SM_CHANNEL_TRAIN', '/opt/ml/input/data/train/rmbg_images'))
